...
function IdentifyingInformation() {
  ...
  // ✅ FETCH TYPE 4 (safe fetch)
  useEffect(() => {

    const fetchPassages = async () => {
      try {

        const res = await fetch(`/start-random-exam?designation=true&type=${testType}`);
      ...
      {showPopup && (
        <div className="popup-overlay">
          <div className="popup-content">
            <h2>
              Test Finished you got {totalCorrect} / {totalQuestions}
            </h2>
        ...
        <section className='questions'>
          ...
          <div className="instructions">
            ...
            <ul className="instructions__list">
              <li className="instructions__item">Choose TRUE if the statement agrees with the information given in the text, choose FALSE if the statement contradicts the information, or choose NOT GIVEN if there is no information on this.</li>
            </ul>
          </div>
                ...
                <div className='question-block' key={q.questionNumber || idx}>
                  ...
                  {optionsArray.map((opt, optionIdx) => (
                    <button
                      ...
                      className={
                        selectedAnswer === opt ? 'active-opt' : 'opt-btn'
                      }
